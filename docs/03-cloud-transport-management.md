...
2. In your global trial account, you have the default **trial** subaccount.
   ...
   ![Create CS Subaccount 00](images/cloud-transport-management/get-started-00.png)
...
3. To create that new subaccount for SAP Cloud Transport Management service, in the **Account Explorer** of your global account, choose **Create > Subaccount**.
   ...
   ![Create CS Subaccount 01](images/cloud-transport-management/get-started-01.png)

4. Enter a **Display Name** (1), here `Central Services` and select a **Region** (2). Choose **Create** (3).

   ![Create CS Subaccount 02](images/cloud-transport-management/get-started-03.png)

   The new subaccount is created.

5. Click on the **Central Services** tile.

   ![Create CS Subaccount 04](images/cloud-transport-management/get-started-04.png)
...
6. You're in the overview of the **Central Services** subaccount. You need to enable Cloud Foundry in the subaccount to create a Cloud Foundry org in which you can create a space. To do this, choose **Enable Cloud Foundry**.
   ...
   ![Create CS Subaccount 05](images/cloud-transport-management/get-started-05.png)

7. Keep the suggested values unchanged, and choose **Create**.

   ![Create CS Subaccount 06](images/cloud-transport-management/get-started-06.png)
...
8. To create a space in this org, choose **Create Space**.

   ![Create CS Subaccount 07](images/cloud-transport-management/get-started-07.png)

9. Enter a space name, here `cTMS` (1), keep the default space roles unchanged, and choose **Create** (2).

   ![Create CS Subaccount 08](images/cloud-transport-management/get-started-08.png)

10. The new **cTMS** space is displayed in the list of spaces.

    ![Create CS Subaccount 09](images/cloud-transport-management/get-started-09.png)
...
1. In your global account in SAP BTP trial, click on the **trial** tile.
   ...
   ![Create CS Subaccount 10](images/cloud-transport-management/get-started-10.png)

2. Choose **Entitlements** from the navigation on the left (1), filter the entries for **transport** (2), and choose **Edit** (3).

   ![Create CS Subaccount 11](images/cloud-transport-management/get-started-11.png)

3. To remove the entitlements for _Cloud Transport Management_ from **trial**, click on the trash bin icons at the end of the row.

   ![Create CS Subaccount 12](images/cloud-transport-management/get-started-12.png)

4. Save your changes.

   ![Create CS Subaccount 13](images/cloud-transport-management/get-started-13.png)

   The entitlements for Cloud Transport Management were removed from the **trial** subaccount.

   ![Create CS Subaccount 14](images/cloud-transport-management/get-started-14.png)
...
2. In your global account, navigate to the subaccount in which you want to use SAP Cloud Transport Management. You might also want to create a new subaccount for this tutorial, if you have the necessary authorizations.
   ...
   ![Subaccounts](images/cloud-transport-management/0010%20Subaccount%20overview.png)
...
3. If Cloud Foundry is not yet configured in your subaccount, you have to do it now. For that, click on **Enable Cloud Foundry** in your subaccount overview.
   ...
   ![EnableCloudFoundry](images/cloud-transport-management/0020%20Enable%20Cloud%20Foundry.png)
...
4. In the dialog window, stay with the defaults and potentially adapt (shorten) the **Org Name**, which still has to be unique. Click on **Create**
   ...
   ![EnableCloudFoundry2](images/cloud-transport-management/0030%20Enable%20Cloud%20Foundry2.png)
...
5. You need to create a space in your Cloud Foundry environment. For this, click on **Create Space** in your subaccount overview.
   ...
   ![CreateSpace](images/cloud-transport-management/0040%20Create%20space.png)

6. In the dialog window, provide a **Space Name**, leave the selected roles unchanged, and click on **Create**.

   ![CreateSpace2](images/cloud-transport-management/0050%20Create%20space2.png)

7. Your subaccount overview should look like this:

   ![SubaccountConfiguredWithCF](images/cloud-transport-management/0060%20subaccount%20configured%20with%20CF.png)
...
1.  In the **Account Explorer** of the global account, click on the **Central Services** tile.
    ...
    ![Move Entitlements 15](images/cloud-transport-management/get-started-15.png)

2.  In the subaccount overview, choose **Entitlements** from the navigation on the left (1), and choose **Edit** (2).

    ![Move Entitlements 16](images/cloud-transport-management/get-started-16.png)

3.  To add entitlements, choose **Add Service Plans**.

    ![Move Entitlements 17](images/cloud-transport-management/get-started-17.png)

4.  In the search field, filter for **transport** (1) and select **Cloud Transport Management** (2).

    ![Move Entitlements 18](images/cloud-transport-management/get-started-18.png)
...
5.  Select both plans (1) - **standard** for API access to Cloud Transport Management, and **lite (Application)** for access to the user interface - and choose **Add 2 Service Plans** (2).
    ...
    ![Move Entitlements 19](images/cloud-transport-management/get-started-19.png)

6.  Filter for **transport** (1) to see the assigned plans for SAP Cloud Transport Management service. Save your changes (2).

    ![Move Entitlements 20](images/cloud-transport-management/get-started-20.png)
...
1. In your subaccount, go to **Services > Service Marketplace** (1). Filter for **transport** (2). The _Cloud Transport Management_ tile is displayed (3).

   ![Subscription1](images/cloud-transport-management/Subscription01.png)

2. Select the three dots (...) on the tile, and choose **Create**.

   ![Subscription2](images/cloud-transport-management/Subscription02.png)

3. On the **New Instance or Subscription** dialog, from the **Plan** dropdown box (1), select **lite** (2) and choose **Create** (3).

   ![Subscription3](images/cloud-transport-management/Subscription03.png)

4. On the **Creation in Progress** dialog, choose **View Subscription**.

   ![Subscription4](images/cloud-transport-management/Subscription04.png)

5. You've subscribed to the _Cloud Transport Management_ application.

   ![Subscription5](images/cloud-transport-management/Subscription05.png)
